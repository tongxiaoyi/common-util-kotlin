...
object JxlUtil {
     ...
     * @param instance
     */
    fun <T : Any> excelCopy(excelFile: String, newExcelFile: String, instance: T, jxlProcessor: JxlProcessor = DEFAULT_JXL_PROCESSOR) {
        try {
    ...
    fun <T : Any> simpleExcelExport(headers: Array<String> = emptyArray(), iterable: Iterable<T>, jxlMappingBean: JxlMappingBean?, file: String, jxlProcessor: JxlProcessor = DEFAULT_JXL_PROCESSOR) {
